...
\subsection{Modèle stochastique : Descente de gradient standard}

Le modèle stochastique consiste à mettre à jour les poids du réseau de neurones après l’observation de chaque position du jeu, plutôt qu’après une moyenne sur un ensemble de données. \\ \\ 
Autrement dit, chaque position $(x_i, y_i)$ est utilisée individuellement pour calculer l’erreur et effectuer une rétropropagation immédiate.\\
